$(document).ready(function() {
	...
	spanInput.show();
	spanInput.css('border-bottom', '1px solid #fff');
	/*spanInput.text("");*/
        ...
        $(".downloads").autocomplete({
			...
			select: function( event, ui ) {
				...
				/*function getWidthOfText(txt, fontname, fontsize){
				  // create dummy span
				  var e=$('body').append('<span class="tempSpan">'+txt+'</span>');
				  // set font parameters
				  $('.tempSpan').css({
					'font-size': fontsize,
				...
				$(this).width(getWidthOfText(selItem, $(this).css('font-family'), $(this).css('font-size')));*/
			}
        });
    });
