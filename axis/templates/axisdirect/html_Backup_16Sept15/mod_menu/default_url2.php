...
switch ($item->browserNav) :
	default:
	case 0:
?><a href="<?php echo $flink; ?>" id="<?php echo $item->id."anch";?>" data-noremove="1" data-type="<?php echo strtolower(str_replace(" ","",$linktype)); ?>" <?php echo $title; ?>><?php echo $linktype; ?></a><?php
		break;
	case 1:
		// _blank
