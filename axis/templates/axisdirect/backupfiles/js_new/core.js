...
$(".thrid-level-menu").on("click",function(){
...
//////////////////////////////for joomla end //////////////////////////////////
    ...
    $('.invest-drop-txt').on('click', function() {
		$('.invest-drop-txt').find('.rea-mod-time').hide();
		$(this).closest('.invest-drop-txt').find('.rea-mod-time').toggle();
    ...
    $('.wish-compare-in').on('click', function() {
        if (!$(this).is(':checked')) {
            $('.sel-msg-fly-in').show();
            $(this).parentsUntil('.wish-compare').find('.wishlist-in').addClass('wishwork');
        }
    });
    $('.cart-list').on('click', '.wishwork', function() {
        $('.sel-msg-fly-in').hide();
  ...
  $div.toggle();
    ...
    $(".next-btn").click(function() {
        if(pos>0){
            $(".tabs-new ul").stop(true, true).animate({left: "-=55px"}, 500);pos--;
        }
    });
    $(".prev-btn").click(function() {
        if(pos<slides){$(".tabs-new ul").stop(true, true).animate({left: "+=55px"}, 500);pos++;}
    });
    ...
    $(".checkpremium,.pop-like").on("click", function() {
