...
<?php if (!strstr($params["view"], "quiz_")) {?>
...
if ($params["option"] != "com_learn" || strstr($params["view"], "_vs") != "_vs") {
    ...
    <div class="header-second-web ">
      ...
      <a href="<?php echo $this->baseurl; ?>/" class="logo"><img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/images/logo.png" class="logo-web"></a></div>
