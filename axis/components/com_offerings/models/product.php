 ...
 * Offerings model.
 */
class OfferingsModelProduct extends JModelItem
{
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_offerings.edit.product.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_offerings.edit.product.id', $id);
		}
	...
	public function getTable($type = 'Product', $prefix = 'OfferingsTable', $config = array())
	{
