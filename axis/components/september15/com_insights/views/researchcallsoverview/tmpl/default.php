...
option=com_users&view=reset&layout=insight_like_popup&tmpl=component" title="insight-like-popup" class="pop-like"><img src="images/buy.png" class="buy-icon"></a></p>
                    ...
                    <div class="checklist clearfix">
     <div class="checkresearch-lft"><a href="javascript:void(0)" data-url="index.php?
option=com_users&view=reset&amp;layout=premium&tmpl=component"class="checkpremium" title="premium"><i class="sprite-img diamond"></i><span>Premium Research plans</span></a></div>
...
option=com_users&view=reset&layout=derivative_pair_popup&tmpl=component" class="view-details ca-more pop-like" title="derivative-pair-popup"><span>View Details</span><i class="sprite-img arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="shadow-panel slide-box">
...
duration, they are compounded Annual Growth Rates.</h4>
                    </div>
                    <div class="stock-details clearfix">
                            <div class="sort-slide-num">
                                <div class="sort-by">
                        ...
                        <ul class="ca-slider mutualfundIdeas-list clearfix">
                            <li class="shadow-panel slide-box">
                                <div class="panel">
                                    ...
                                    <div class="panel-footer">
                                        <a href="javascript:void(0)" class="primary-btn">Invest</a>
                                        <a href="javascript:void(0)" data-url="index.php?option=com_users&view=reset&layout=mutual_popup&tmpl=component" class="view-details ca-more pop-like"  title="mutual-popup"><span>View Details</span><i class="sprite-img arrow-right"></i></a>
                                    </div>
                                </div>
                            </li>
                            <li class="shadow-panel slide-box">
