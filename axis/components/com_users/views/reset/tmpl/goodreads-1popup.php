...
<div class="vdetail-title clearfix">
	...
	<div class="dialog-title lern-regpop goodread-hea clearfix">
		<h2>Common man always benefits from a rate cut</h2>
		<p class="reg-hea-con">Excerpts of a select interview with Dr. Raghuram Rajan.</p>
		<p class="mt10">Sep, 30, 2015 | Source: THE HINDU</p>
	</div>
</div>
