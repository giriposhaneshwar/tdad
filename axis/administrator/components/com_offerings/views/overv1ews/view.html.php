 ...
 */
class OfferingsViewOverv1ews extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        OfferingsHelper::addSubmenu('overv1ews');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_OFFERINGS_TITLE_OVERV1EWS'), 'overv1ews.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_offerings&view=overv1ews');
