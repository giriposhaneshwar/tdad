 ...
 */
class OfferingsViewPlatformsmobileapps extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        OfferingsHelper::addSubmenu('platformsmobileapps');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_OFFERINGS_TITLE_PLATFORMSMOBILEAPPS'), 'platformsmobileapps.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/platforms_mobileapp';
        if (file_exists($formPath)) {

            if ($canDo->get('core.create')) {
                JToolBarHelper::addNew('platforms_mobileapp.add', 'JTOOLBAR_NEW');
            }

            if ($canDo->get('core.edit') && isset($this->items[0])) {
                JToolBarHelper::editList('platforms_mobileapp.edit', 'JTOOLBAR_EDIT');
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_offerings&view=platformsmobileapps');
