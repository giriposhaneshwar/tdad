...
/**
 * Methods supporting a list of Nri_offerings records.
 */
class Nri_offeringsModelOfferingsvalueaddedservicess extends JModelList
{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_NRI_OFFERINGS_SEARCH_FILTER_DATE_FORMAT"), "warning");
