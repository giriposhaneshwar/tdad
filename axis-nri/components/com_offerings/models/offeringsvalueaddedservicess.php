...
/**
 * Methods supporting a list of Offerings records.
 */
class OfferingsModelOfferingsvalueaddedservicess extends JModelList
{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_OFFERINGS_SEARCH_FILTER_DATE_FORMAT"), "warning");
