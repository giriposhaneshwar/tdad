<div class="likepop">
        ...
        <h3 class="car-pop-hea thank-pop">To Start your health Check</h3>
                    ...
                    <ul class="feed-form">
                     ...
                     <li class="hea-check-pop">
                        <input type="email" placeholder="Enter your Email id" class="inp-filed"/>
                     </li>
                     <li>
                         <button type="button" class="primary-btn healcheck">Submit</button>
                     </li>
                     </ul>
                </form>
    ...
    <h3 class="car-pop-hea thank-pop">To Start your health Check</h3>
                    ...
                    <ul class="feed-form">
                     ...
                     <li>
                         ...
                         <button type="button" class="primary-btn thank-you">Submit</button>
                     </li>
                     </ul>
                </form>
			</div>
    ...
    <p class="home-mob-comment">for verifying your Email.</p>
